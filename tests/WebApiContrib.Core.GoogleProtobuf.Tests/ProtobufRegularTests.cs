...
namespace WebApiContrib.Core.GoogleProtobuf.Tests
{
    ...
    public class ProtobufRegularTests
    {
        private TestServer _server;

        public ProtobufRegularTests()
        {
            _server = new TestServer(new WebHostBuilder()
                ...
                .ConfigureServices(services => services
                    .AddMvcCore()
                    .AddProtobufFormatters(options => options.UseDelimitedFormat = false)));
        }
        ...
        public async Task GetCollection_X_Protobuf_Header()
        {
            ...
            await Assert.ThrowsAsync<NotSupportedException>(() => client.SendAsync(request));
        }
        ...
        public async Task GetById_Protobuf_Header()
        {
            ...
            var book = Book.Parser.ParseFrom(await result.Content.ReadAsStreamAsync());
        ...
        public async Task Post_X_Protobuf_Header()
        {
            ...
            var echo = Book.Parser.ParseFrom(await result.Content.ReadAsStreamAsync());
